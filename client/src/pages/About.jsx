        ...
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row align-items-center">
            <div className="relative lg:h-[600px] w-full lg:w-3/4 lg:w-1/2 xl:w-[560px] xl:top-[90px] z-10 order-2 lg:order-1 ">
              <img loading="lazy"  className="max-h-full max-w-full rounded mx-auto" src={banner} alt="image" />
            </div>
        ...
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <div className="flex justify-center gap-5">
              <img loading="lazy"  className="w-[150px]" src={img10} />
              <img loading="lazy"  className="w-[150px]" src={img14} />
            </div>
      ...
      <section>
        <div className="container">
          ...
          <div>
            <Slider {...settings}>
              <div>
                <img loading="lazy" className="w-[150px]" src={img5} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img4} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img3} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img2} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img8} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img9} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img15} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img12} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img13} />
              </div>
              <div>
                <img loading="lazy" className="w-[150px]" src={img11} />
              </div>
